...
func newThemeRegistry() *themeRegistry {
	...
	registryMap := map[string]*theme{
		"blackToWhite":  &blackToWhite,  "blackToBlue":  &blackToBlue,
		"blackToGreen":  &blackToGreen,  "blackToRed":   &blackToRed,
		"blackToYellow": &blackToYellow, "blueToRed":    &blueToRed,
		"blueToGreen":   &blueToGreen,   "greenToBlue":  &greenToBlue,
		"greenToYellow": &greenToYellow, "fire":         &fire,
		"thermal":       &thermal,       "sunset":       &sunset,
		"ocean":         &ocean,         "rainbow":      &rainbow,
		"rainbow2":      &rainbow2,      "retro":        &retro,
		"vaporwave":     &vaporwave,     "toxic":        &toxic,
		"trans":         &trans,         "pride":        &pride,
		"bi":            &bi,            "pan":          &pan,
		"matrix":        &matrix,        "glacier":      &glacier,
		"autumn":        &autumn,        "cyberpunk":    &cyberpunk,
		"magma":         &magma,         "nebula":       &nebula,
		"hazard":        &hazard,        "coffee":       &coffee,
		"arcade":        &arcade,        "prism":        &prism,
		"biohazard":     &biohazard,     "supernova":    &supernova,
